...
class BareSoC(SoCCore):
    def __init__(self, platform, clk_freq, sys_clk_freq=int(50e6), **kwargs):
        ...
        self.platform = platform = alinx_ac1006_ax1006.Platform()

        # SoCMini ----------------------------------------------------------------------------------
        SoCMini.__init__(self, platform, sys_clk_freq,
            ident         = "LiteX BareSoC on Alinx AC1006 core AX1006 IO",
            ident_version = True,
            **kwargs)
...
class BaseSoC(SoCCore):
    def __init__(self,
        ...
        SoCCore.__init__(self, platform, sys_clk_freq,
            ident         = "LiteX BaseSoC on Alinx AC1006 core AX1006 IO",
            ident_version = True,
            **kwargs)
...
def main():
    parser = argparse.ArgumentParser(description="LiteX SoC on Alinx AC1006 core AX1006 IO")
