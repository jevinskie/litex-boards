    ...
    def __init__(self,
        ...
        if with_ethernet or with_etherbone:
            ...
            self.submodules.ethphy = LiteEthPHYMII(
                ...
                pads       = eth_pads0)
            self.ethphy = ClockDomainsRenamer({"ethphy_eth_rx": "eth_rx", "ethphy_eth_tx": "eth_tx"})(self.ethphy)
            ...
            if with_ethernet:
                ...
                self.ethernet = ClockDomainsRenamer({"ethphy_eth_rx": "eth_rx", "ethphy_eth_tx": "eth_tx"})(self.ethernet)
            if with_etherbone:
                self.add_etherbone(phy=self.ethphy, ip_address=eth_ip)
                self.etherbone = ClockDomainsRenamer({"ethphy_eth_rx": "eth_rx", "ethphy_eth_tx": "eth_tx"})(self.etherbone)
            ...
            self.etherbone1 = ClockDomainsRenamer({"ethphy1_eth_rx": "eth_rx", "ethphy1_eth_tx": "eth_tx"})(self.etherbone1)
